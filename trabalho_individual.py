...
Original file is located at
    https://colab.research.google.com/drive/1XvzGhqBxioc9P_Mz4WX7dgorsQqAEW6v
...
while True:
    ...
    while True:
        try:
            ...
            media = int(input("Digite a média do candidato (apenas números inteiros): "))
            break
        except ValueError:
            print("Por favor, digite apenas números inteiros.")

    # Adicionar o registro à lista de registros de candidatos
    registro = f"Candidato: {candidato}, Entrevista: {entrevista}, Teste Teórico: {teste_teorico}, Teste Prático: {teste_pratico}, Soft Skills: {soft_skills}, Média: {media}"
